...
public class WebConfig implements WebMvcConfigurer {
    ...
    public CommandLineRunner dataLoader(IngredientRepository repo,
        ...
        return args -> {
            ...
            repo.save(flourTortilla); repo.save(cornTortilla); repo.save(groundBeef);
            repo.save(carnitas); repo.save(tomatoes); repo.save(lettuce);
            repo.save(cheddar); repo.save(jack); repo.save(salsa); repo.save(sourCream);
            ...
            String password = "111";
            User user = new User("111",encoder.encode(password),"111","111","111", "111","111", "111");
            userRepo.save(user);
        };
    }
